...
import static task.task5.MethodCollection.*;

public class WorkTimeCollections {
    public static void main(String[] args) {
        List arraylist = new ArrayList<>();
        List linkedlist = new LinkedList();

// method add
//        System.out.println("functional add");
...
//        System.out.println("час виконання arraylist: "+addElementByIndex(arraylist,2)+ " секунд");
//        System.out.println("час виконання linkedlist: "+addElementByIndex(linkedlist,2)+ " секунд");
///*---------------------------------------*/
...
//
//
// method get first half element
//        System.out.println("functional get some first half element");
...
//        System.out.println("functional remove last element");
